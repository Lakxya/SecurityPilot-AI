  ...
  if (isCollapsed) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-indigo-600 hover:bg-indigo-500 text-white p-3.5 rounded-full shadow-2xl flex items-center gap-2 border border-indigo-400/40 transition-all font-mono text-xs"
      >
      ...
      <header className="h-14 px-4 border-b border-slate-800 flex items-center justify-between shrink-0 bg-slate-950">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1 text-slate-500 hover:text-rose-400 text-xs transition-colors"
          >
            🗑️
          </button>
          ...
          <button
            ...
            className="p-1 text-slate-500 hover:text-white text-xs transition-colors"
          >
            ✕
          </button>
        </div>
