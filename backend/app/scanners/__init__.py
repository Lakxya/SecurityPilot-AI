...
from app.scanners.aws import AWSScanner, AWSIAMScanner, AWSS3Scanner, AWSEC2Scanner, AWSCloudTrailScanner, AWSKMSScanner, AWSConfigScanner, AWSGuardDutyScanner, AWSSecurityHubScanner, AWSInspectorScanner, AWSECRScanner, AWSSecretsManagerScanner, AWSRDSScanner, AWSLambdaScanner, AWSWAFScanner, AWSCloudFrontScanner, AWSDynamoDBScanner, AWSELBScanner, AWSOpenSearchScanner, AWSAPIGatewayScanner, AWSSNSQSScanner, AWSECSEKSScanner, AWSVPCScanner
...
def init_scanners():
    ...
    scanner_registry.register("aws_config", AWSConfigScanner())
    ...
    scanner_registry.register("aws_secretsmanager", AWSSecretsManagerScanner())
    scanner_registry.register("aws_rds", AWSRDSScanner())
    scanner_registry.register("aws_lambda", AWSLambdaScanner())
    scanner_registry.register("aws_waf", AWSWAFScanner())
    scanner_registry.register("aws_cloudfront", AWSCloudFrontScanner())
    scanner_registry.register("aws_dynamodb", AWSDynamoDBScanner())
    scanner_registry.register("aws_elb", AWSELBScanner())
    scanner_registry.register("aws_opensearch", AWSOpenSearchScanner())
    scanner_registry.register("aws_apigateway", AWSAPIGatewayScanner())
    scanner_registry.register("aws_snssqs", AWSSNSQSScanner())
    scanner_registry.register("aws_ecseks", AWSECSEKSScanner())
    scanner_registry.register("aws_vpc", AWSVPCScanner())
